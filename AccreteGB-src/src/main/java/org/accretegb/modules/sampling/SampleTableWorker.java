 ...
 */
public class SampleTableWorker extends PopulateTableWorker {

	public SampleTableWorker(DefaultTableModel model, Map<String, String> sqlParameters, JProgressBar progressBar) {
...
/*
    ...
    public String createSQLQuery(Map<String, String> sqlParameters) {
        ...
        queryBuff
                .append("select plot, tagname, parameter_name, value, units, measurement_type, tom"
        ...
        if (sqlParameters.get("field_id") != null) {
	        ...
	        if (sqlParameters.get("parameter_name") != null) {
	            String parameter = sqlParameters.get("parameter_name");
	            queryBuff.append(" and measurement_parameter.parameter_name ='" + parameter + "'");
	        }
