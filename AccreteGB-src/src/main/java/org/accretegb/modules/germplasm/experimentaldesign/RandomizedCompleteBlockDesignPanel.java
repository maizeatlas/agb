...
/**
 * @author nkumar
 * does tha layout of panel for randomized complete block design
 */
public class RandomizedCompleteBlockDesignPanel extends JPanel {
    ...
    /**
     * initializes the layout of the panel for randomized complete block design
     */
    public void initialize() {
        setLayout(new MigLayout("insets 5 0 5 5, gapx 0"));
        add(new JLabel("Randomized Complete Block Desgin"), "span, grow, wrap");
