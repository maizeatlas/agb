...
/**
 * @author tnj
 * do the layout of the complete AlphaDesign panel
 */
public class AlphaDesignPanel extends JPanel {
    ...
    public void initialize() {
        ...
        add(new JLabel("Alpha Design (0,1)"), "span, grow, wrap");
        add(new JLabel("Replications"), "pushx");
        getReps().setColumns(11);
        add(getReps(), "w 100%, growx, wrap");
        add(new JLabel("Blocks"), "pushx");
        getBlockSize().setColumns(11);
        add(getBlockSize(), "w 100%,growx, wrap");
    ...
    public JTextField getBlockSize() {
		return blockSize;
	}

	public void setBlockSize(JTextField blockSize) {
