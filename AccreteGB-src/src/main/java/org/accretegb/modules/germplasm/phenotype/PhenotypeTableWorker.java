...
public class PhenotypeTableWorker extends PopulateTableWorker {
	...
	public String createSQLQuery(Map<String, String> sqlParameters) {
		...
		.append("select distinct tagname," 
				...
				+ (sqlParameters.get("exp_factor_names") != null ? " left join experiment_factor_value on observation_unit.observation_unit_id=experiment_factor_value.observation_unit_id left join experiment_factor on experiment_factor.experiment_factor_id = experiment_factor_value.experiment_factor_id" : "")
		...
		if (sqlParameters.get("exp_factor_names") != null) {
			String parameter = sqlParameters.get("exp_factor_names");
			queryBuff.append(" and experiment_factor.exp_factor_name in (" + parameter + ")");
		}
		...
		if (sqlParameters.get("sampleName") != null) {
			String parameter = sqlParameters.get("sampleName").replace("*", "%");
	...
	private String getExperimentQueryParts(String factors) {
